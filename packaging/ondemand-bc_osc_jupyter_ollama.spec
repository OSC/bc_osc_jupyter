...
%global repo_name bc_osc_jupyter_ollama
%global app_name bc_osc_jupyter_ollama
...
Summary:  Batch Connect - OSC Jupyter Notebook + Ollama
...
%description
An interactive app designed for OSC OnDemand that launches a Jupyter Notebook server with Ollama running in background within a Cardinal batch job.
